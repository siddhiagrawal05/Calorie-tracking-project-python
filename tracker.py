...
if save == "yes":
    ...
    with open(filename, "a") as file:
        ...
        file.write("-------------------------------------\n")       
        if total_calories > daily_limit:
          file.write(" Warning: You have exceeded your daily calorie limit! ")
          file.write(f"\n {total_calories - daily_limit} calories over the limit!")
        else:
          file.write(" Congratulations! you are within your daily calorie limit. ")
          calories_left = daily_limit - total_calories
          file.write(f"\n You can take {calories_left} calories more.")
          file.write("-------------------------------------\n")
        import datetime
        file.write("\n-------------------------------------\n")
